...
if __name__ == '__main__':
    ...
    imgLoader = torch.utils.data.DataLoader(img_loader, batch_size=batch_number, shuffle=True, num_workers=8)

    DCPModule = DCPDehazeGenerator(win_size_a=15, win_size_t=15).to(device)
